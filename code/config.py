...
SELECTED_FEATURES = ['volatility_SOLUSDT', 'sol_btc_corr', 'sol_eth_corr', 'close_SOLUSDT_lag1', 'close_BTCUSDT_lag1', 'close_ETHUSDT_lag1', 'volume_change_SOLUSDT', 'volatility_BTCUSDT', 'volume_change_BTCUSDT', 'momentum_SOLUSDT', 'close_SOLUSDT_lag30', 'close_BTCUSDT_lag30', 'close_ETHUSDT_lag30', 'sol_btc_ratio', 'sol_btc_ratio_lag1', 'sol_eth_ratio', 'sol_eth_ratio_lag1', 'sign_logreturn_lag1_SOL', 'sign_logreturn_lag30_SOL', 'momentum_filter_SOL', 'vader_sentiment_compound', 'vader_sentiment_pos', 'vader_sentiment_neg']
MODEL_PARAMS = {'n_estimators': 1000, 'learning_rate': 0.01, 'max_depth': 5, 'num_leaves': 31, 'hidden_size': 128, 'num_layers': 3, 'reg_alpha': 0.1, 'reg_lambda': 0.1}
OPTUNA_TRIALS = int(os.getenv('OPTUNA_TRIALS', 100))
USE_SYNTHETIC_DATA = os.getenv('USE_SYNTHETIC_DATA', 'True')
BLEND_REAL_SYNTHETIC = True
BLEND_RATIO = 0.5  # Blend 50% real and 50% synthetic data
NAN_HANDLING = 'interpolate'  # Fix NaNs with interpolation
