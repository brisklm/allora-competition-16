...
SELECTED_FEATURES = ['volatility_SOLUSDT', 'sol_btc_corr', 'sol_eth_corr', 'close_SOLUSDT_lag1', 'close_BTCUSDT_lag1', 'close_ETHUSDT_lag1', 'volume_change_SOLUSDT', 'volatility_BTCUSDT', 'volume_change_BTCUSDT', 'momentum_SOLUSDT', 'close_SOLUSDT_lag30', 'close_BTCUSDT_lag30', 'close_ETHUSDT_lag30', 'sol_btc_ratio', 'sol_eth_ratio', 'log_return_SOLUSDT_lag1', 'sign_return_SOLUSDT_lag1', 'momentum_filter_SOLUSDT', 'vader_sentiment_score', 'volatility_ETHUSDT', 'volume_change_ETHUSDT', 'eth_btc_corr']
MODEL_PARAMS = {'n_estimators': 1200, 'learning_rate': 0.002, 'max_depth': 6, 'num_leaves': 40, 'reg_lambda': 0.2, 'reg_alpha': 0.1, 'hidden_size': 128, 'num_layers': 3, 'dropout': 0.1}
OPTUNA_TRIALS = int(os.getenv('OPTUNA_TRIALS', 100))
USE_SYNTHETIC_DATA = os.getenv('USE_SYNTHETIC_DATA', 'Blend')  # Changed to Blend for real/synthetic blending
BLEND_RATIO = 0.5  # 50% real, 50% synthetic
SIA = SentimentIntensityAnalyzer()  # Instantiate VADER for sentiment analysis