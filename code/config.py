...
SELECTED_FEATURES = ['volatility_SOLUSDT', 'sol_btc_corr', 'sol_eth_corr', 'close_SOLUSDT_lag1', 'close_BTCUSDT_lag1', 'close_ETHUSDT_lag1', 'volume_change_SOLUSDT', 'volatility_BTCUSDT', 'volume_change_BTCUSDT', 'momentum_SOLUSDT', 'close_SOLUSDT_lag30', 'close_BTCUSDT_lag30', 'close_ETHUSDT_lag30', 'sol_btc_ratio', 'sol_eth_ratio', 'log_return_SOLUSDT_lag1', 'sign_return_SOLUSDT_lag1', 'volatility_ETHUSDT', 'volume_change_ETHUSDT', 'sentiment_score', 'momentum_filter']
MODEL_PARAMS = {'n_estimators': 1000, 'learning_rate': 0.01, 'hidden_size': 128, 'num_layers': 3, 'max_depth': 8, 'reg_alpha': 0.1, 'reg_lambda': 0.1}
