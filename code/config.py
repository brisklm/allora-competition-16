...
SELECTED_FEATURES = ['volatility_SOLUSDT', 'sol_btc_corr', 'sol_eth_corr', 'close_SOLUSDT_lag1', 'close_BTCUSDT_lag1', 'close_ETHUSDT_lag1', 'volume_change_SOLUSDT', 'volatility_BTCUSDT', 'volume_change_BTCUSDT', 'momentum_SOLUSDT', 'close_SOLUSDT_lag30', 'close_BTCUSDT_lag30', 'close_ETHUSDT_lag30', 'log_return_SOLUSDT_lag1', 'sign_SOLUSDT_lag1', 'sol_eth_ratio', 'sol_btc_ratio', 'vader_sentiment', 'momentum_filter_5', 'eth_btc_ratio', 'volatility_ETHUSDT']
MODEL_PARAMS = {'n_estimators': 1200, 'learning_rate': 0.003, 'max_depth': 6, 'num_leaves': 40, 'reg_alpha': 0.05, 'reg_lambda': 0.05, 'hidden_size': 128, 'num_layers': 3}
