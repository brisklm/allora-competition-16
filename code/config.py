...
SELECTED_FEATURES = ['volatility_SOLUSDT', 'sol_btc_corr', 'sol_eth_corr', 'close_SOLUSDT_lag1', 'close_BTCUSDT_lag1', 'close_ETHUSDT_lag1', 'volume_change_SOLUSDT', 'volatility_BTCUSDT', 'volume_change_BTCUSDT', 'momentum_SOLUSDT', 'close_SOLUSDT_lag30', 'close_BTCUSDT_lag30', 'close_ETHUSDT_lag30', 'sol_btc_ratio', 'sol_eth_ratio', 'log_return_SOLUSDT_lag1', 'sign_return_SOLUSDT_lag1', 'rsi_SOLUSDT_14', 'macd_SOLUSDT', 'vader_sentiment_score']
MODEL_PARAMS = {'n_estimators': 1000, 'learning_rate': 0.01, 'max_depth': 6, 'num_leaves': 31, 'reg_alpha': 0.1, 'reg_lambda': 0.1, 'hidden_size': 128, 'num_layers': 3}
...
HANDLE_NANS = True  # Flag to fix NaNs and low variance in preprocessing
SIA = SentimentIntensityAnalyzer()  # VADER instance for sentiment analysis